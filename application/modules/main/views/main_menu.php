...
<li <?php if(isset($m_kartu)) { ?>class = "active" <?php } ?>><a href='<?php echo site_url('main/examples/kamera')?>'><i class="fa fa-camera"></i> <span>Foto Anggota</a></span></li>

<li <?php if(isset($m_ustok)) { ?>class = "active" <?php } ?>><a href='<?php echo site_url('main/examples/update_data')?>'><i class="fa fa-upload"></i> <span>Update Data</a></span></li>
<li <?php if(isset($m_ustok)) { ?>class = "active" <?php } ?>><a href='<?php echo site_url('main/examples/rekap_penjualan')?>'><i class="fa fa-line-chart"></i> <span>Rekap Penjualan</a></span></li>
